...
error_reporting(E_ALL);
	...
	if (Auth::isLoggedIn()) {
		if (Auth::getUserInfo()['iSolutionsUsername'] == "gkjt1g15" || Auth::getUserInfo()['iSolutionsUsername'] == "gct2g14") {
?>
...
?>
	...
	<div class="well well-pa">
		...
		<p>Please login <a href="/archive/login?continue=/results.php">here</a> to view the results!</p>
	</div>
...
<?php
	...
	function printResults() {
		...
		$sections = [
				...
				"dedication" => "Most Dedicated to PA",
	...
	function getNumberOfVotes($code, $db) {
		...
		$res = mysqli_fetch_assoc($db->query("SELECT COUNT(".$code."_1) as noOfVotes FROM perform.awards_vote_18 WHERE ".$code."_1 != 'No vote\n'"));
