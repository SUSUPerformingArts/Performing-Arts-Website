...
<?php
	...
	$SQLstring = "SELECT itemID FROM `House_Checkout` WHERE userName='$username' AND dateIn is NULL";
	...
	do {
		$SQLstring2 = "SELECT * FROM `House_Item` WHERE id=$itemID";
		...
		echo "<td class='tableName'><a href='/house/item.php?id=$id'>$name</a></td>";
		...
		echo "<td class='tableAction'><a href='/house/checkinSuccess.php?id=$id'>Check in</a></td></tr>";
