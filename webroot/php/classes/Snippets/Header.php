...
class Header implements SnippetInterface {
  ...
  public static function printFancySubHeader($theme=0, $title="", $subTitle="", $tag="", $imagePath=null) {
	...
	/** Print the visual naviagtion bar for the new site ***/
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <span class="navbar-brand"><!--<a class="susu" href="http://www.susu.org"><img src="/img/logos/susu.png" alt="SUSU Logo"></a>--><a id="pa_brand" class="navbar-brand " style="margin-left:5px; padding: 10px 5px; " href="/"><img src="/img/icons/pa_grey.svg" style="height: 100%; margin-top: -4px; " alt="Performing Arts" /></a></span>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="/about/pacard">The PA Card</a></li>
                                <li><a href="/about/committee">Your Committee</a></li>
                                <li><a href="/about/dance">Union Southampton Dance (USD)</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="/societies/music">Music</a></li>
                                <li><a href="/societies/dance">Dance</a></li>
                                <li><a href="/societies/theatrical/#tech">Tech</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="/rehearsals">Rehearsals and Meetings</a></li>
                            </ul>
                        </li>
    ...
    public static function printUserNavNormal($archiveBase = ""){
        $uri = $_SERVER["REQUEST_URI"];
        ?>
            <ul class="nav navbar-nav navbar-right hidden-xs">
                <?php if(Auth::isLoggedIn()){ ?>
				<li><a class="pull-right" href="/resources">Resources</a></li>
    ...
    public static function printUserNavMobile($archiveBase = "/"){
        $uri = $_SERVER["REQUEST_URI"];
        if(Auth::isLoggedIn()){
            ?>
