...
class Header implements SnippetInterface {
  ...
  public static function printFancySubHeader($theme=0, $title="", $subTitle="", $tag="", $imagePath=null) {
    if ($theme==0) $theme="pa_container";
    if ($theme==1) $theme="theatrical";
    if ($theme==2) $theme="music";
    if ($theme==3) $theme="dance";
    
    echo "</main><main class=\"container $theme\"><main class=\"container\">";
		  echo "<div class=\"row\">";
			  echo "<div id=\"fancy-header-col\" class=\"col-md-12\" style=\"height:160px; padding:0px; margin-left:15px; width: calc(100% - 30px)\">";
				  echo "<div id=\"fancy-header-title-cont\" style=\"position: absolute; bottom: -12px; left:0\">";
					  echo "<h1 id=\"fancy-header-title\" style=\"font-size: 72px; line-height: 0.8em; color: ";
    					  if ($theme=="pa_container") echo "#f7e6f6";
    					  if ($theme=="theatrical") echo "#eef9f6";
    					  if ($theme=="music") echo "#ecf4f9";
    					  if ($theme=="dance") echo "#fffaed";
    				  echo "; font-variant: small-caps;\">";
    				    $titleWords = explode(" ", ucwords(trim(preg_replace('/\s+/', ' ',$title))));
  						
                        foreach ($titleWords as $titleWord) {
                            echo "<span>" . $titleWord . " </span>"; 
                        }
  					echo "</h1>";
  				echo "</div>";
  				...
  				if (!is_null($imagePath)) {
  				  $style = "";
  				  if (strpos($imagePath, "silhouette") > 0) $style = "style=\"bottom: 0\"";
  				  echo "<div class=\"headerSilhouette\" $style><img src=\"$imagePath\" style=\"max-height:95px\" /></div>";
  				}
  				
  				echo "<div class=\"topleft-indicator\">$tag</div>";
  				
  				echo "<div class=\"headerSubtitle\">$subTitle</div>";
    ...
    ?>
        <script>
            function getNoOfLines() {
                var titleParts = $("#fancy-header-title").children("span");
                var newLineIndent;
                var noOfLines = 1;

                for (i in titleParts) {
                    var titlePart = $(titleParts[i]);
                    if (titlePart.html() === undefined || !$.isNumeric(i)) continue;

                    if (i === "0") {
                        newLineIndent = titlePart.position().left;
                    } else {
                        if (titlePart.position().left === newLineIndent) {
                            noOfLines++;
                        }
                    }
                }
            ...
            function adjustFancyTitle() {
                var widthOfImg = $(".headerSilhouette").width();
                if ($(window).width() >= 900)
                    $("#fancy-header-title-cont").css("width", "calc(100% - "+widthOfImg+"px)");

              if (getNoOfLines()>1) {
                if ($("#fancy-header-col").text().indexOf(":") > 0) {
                // First port of call, split at a Colon
                
                  $("#fancy-header-title").children("br").remove();
                  var titleParts = $("#fancy-header-title").children("span");
                  ...
                  for (i in titleParts) {
                     ...
                     if (titlePart.html().indexOf(":") > 0) titlePart.after("<br />");
                  }
                } else {
                  // Otherwise, just pack the bottom line
                  
                  $("#fancy-header-title").children("br").remove();
                  var initialNoOfLines=getNoOfLines();
                  var spans = $("#fancy-header-title").children("span");
                  
                  for (var i=0; i < spans.length; i++) {
                    var span = $(spans[i]);
                    span.after("<br />");
                    if (getNoOfLines() > initialNoOfLines) {
                      $("#fancy-header-title").children("br").remove();
                    } else {
                      break;
                    }
              ...
              var extraSpace = 0;
              if (getNoOfLines()>2) {
                  extraSpace = (getNoOfLines()-2)*72;
              }

              $("#fancy-header-col").css('height', (160 + extraSpace) + 'px');
            }

            $(function() {
                adjustFancyTitle();
                $( window ).resize(adjustFancyTitle);
            });
        </script>
    <?php
    
    echo "<main class=\"container pa-main-content\">";
    ...
    public static function printBlankHeader($title = "SUSU Performing Arts", $scripts = null, $css = null, $jqueryVersion = null){
        self::printHead($title, $scripts, $css, $jqueryVersion);
        self::printBlankNav();
    }
    ...
    /** Print Nav without any nav for embedding **/
    public static function printBlankNav() {
        ?>
	...
	/** Print the visual naviagtion bar for the new noArchive site ***/
    public static function printNewNav(){
    ?>
    <div class="pa-wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <span class="navbar-brand"><!--<a class="susu" href="http://www.susu.org"><img src="/img/logos/susu.png" alt="SUSU Logo"></a>--><a id="pa_brand" class="navbar-brand " style="margin-left:5px; padding: 10px 5px; " href="/noArchive/"><img src="/img/icons/pa_grey.svg" style="height: 100%; margin-top: -4px; " alt="Performing Arts" /></a></span>
                </div>
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="/about" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">About PA <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/noArchive/about">About</a></li>
                                <li><a href="/noArchive/about/pacard">The PA Card</a></li>
                                <li><a href="/noArchive/about/committee">Your Committee</a></li>
                                <li><a href="/noArchive/about/dance">Union Southampton Dance (USD)</a></li>
								        <li><a href="/noArchive/members">Members</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            <a href="/societies" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Societies <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/noArchive/societies/theatrical">Theatrical</a></li>
                                <li><a href="/noArchive/societies/music">Music</a></li>
                                <li><a href="/noArchive/societies/dance">Dance</a></li>
                                <li><a href="/noArchive/societies/theatrical/#tech">Tech</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            <a href="/calendar" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">What's on <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/noArchive/shows">Shows</a></li>
                                <li><a href="/noArchive/rehearsals">Rehearsals and Meetings</a></li>
                            </ul>
                        </li>
                        ...
                        <?php self::printUserNavMobile("/noArchive"); ?>

                    </ul>

                    <?php self::printUserNavNormal("/noArchive"); ?>
    ...
    public static function printUserNavNormal($archiveBase = "/archive"){
        $uri = $_SERVER["REQUEST_URI"];
        ?>
            <ul class="nav navbar-nav navbar-right hidden-xs">
                <?php if(Auth::isLoggedIn()){ ?>
				<li><a class="pull-right" href="/noArchive/resources">Resources</a></li>
    ...
    public static function printUserNavMobile($archiveBase = "/archive"){
        $uri = $_SERVER["REQUEST_URI"];
        if(Auth::isLoggedIn()){
            ?>
