...
<div class="container-fluid">
	<div class="row-fluid">
     	<h1><a class="one" href="http://perform.susu.org/House/home.php">PA House System</a></h1>
	</div>
<?php
...
<form method="post" action="uploadItem.php" enctype="multipart/form-data">
	...
	<a href="http://perform.susu.org/House/roomPlan.jpg" target="_blank">See room plan</a></br>
