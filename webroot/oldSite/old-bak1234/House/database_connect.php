...
function permission_check($permission1, $permission2, $permission3, $permission4, $errmsg) {
	...
	if(isset($_SESSION['username'])) {
		...
		if(($Row['permissions'] == $permission1) || ($Row['permissions'] == $permission2) || ($Row['permissions'] == $permission3) ||($Row['permissions'] == $permission4)) {
			die("<h3>$errmsg</h3>");
			//echo '<meta http-equiv="refresh" content="3; URL=http://perform.susu.org/House/home.php">';
		}
	}
	else {
			...
			echo "<tbody>";
					...
					do {		
						...
						if($type == "theatricalCostume")
							echo "<td><a href='http://perform.susu.org/House/itemCostume.php?id=$itemID&type=$type'>$name</a></td>";
						elseif($type == "theatricalProp")
							echo "<td><a href='http://perform.susu.org/House/itemProp.php?id=$itemID&type=$type'>$name</a></td>";
						elseif($type == "theatricalSet")
							echo "<td><a href='http://perform.susu.org/House/itemSet.php?id=$itemID&type=$type'>$name</a></td>";
						elseif($type == "drapes")
							echo "<td><a href='http://perform.susu.org/House/itemDrapes.php?id=$itemID&type=$type'>$name</a></td>";
						elseif($type == "music")
							echo "<td><a href='http://perform.susu.org/House/itemMusic.php?id=$itemID&type=$type'>$name</a></td>";
						elseif($type == "dance")
							echo "<td><a href='http://perform.susu.org/House/itemDance.php?id=$itemID&type=$type'>$name</a></td>";
						elseif($type == "misc")
							echo "<td><a href='http://perform.susu.org/House/itemMisc.php?id=$itemID&type=$type'>$name</a></td>";
			...
			echo "<td><h5>Action: </h5>
				<form>
					<select name='URL' onchange='window.location.href=this.form.URL.options[this.form.URL.selectedIndex].value'>
						<option value=''></option>
						<option value='http://perform.susu.org/House/item.php?id=$id&type=$type'>Un-Retire Item</option>
 					</select>
				</form></td></tr>";
		}
		elseif ($checkStatus) {
