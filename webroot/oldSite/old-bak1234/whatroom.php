...
<div class="row-fluid">
   <?php
	...
	for($i=0;$i<$num;$i++){
		...
		$welcomedeets = mysql_result($result,$i,"welcomemeeting");
		echoSoc($id,$name,$description,$logo,$website,$facebook,$twitter,$welcomedeets);
		if($count>2)
		{
...
<div class="row-fluid">
   <?php
	...
	for($i=0;$i<$num;$i++){
		...
		$subtitle = mysql_result($result,$i,"subtitle");
		$description = mysql_result($result,$i,"description");
		$website = mysql_result($result,$i,"description");
		$facebook = mysql_result($result,$i,"facebook");
		$twitter = mysql_result($result,$i,"twitter");
		$welcomedeets = mysql_result($result,$i,"welcomemeeting");
		echoSoc($id,$name,$description,$logo,$website,$facebook,$twitter,$welcomedeets);
...
include 'footer.php';
	...
	function echoSoc($id,$name, $description, $logo, $website, $facebook, $twitter, $welcomedeets){
		...
		// Huzzah for lovely, hacky, last-minute coding! Yaaaaaay! (sorry future Webmaster, I bow my head in shame)
		$facebook="";
		$twitter="";
		$website="";
