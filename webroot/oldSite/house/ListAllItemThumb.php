...
<?php
	$SQLstring = "SELECT * FROM `House_Item`";
	...
	do {
		...
		echo "<p style='display: block; height: 150px; width: 250px; margin-left: auto; margin-right:auto'><img src='".$filename."' width='180' height='180' orientation: 90deg></p>";
