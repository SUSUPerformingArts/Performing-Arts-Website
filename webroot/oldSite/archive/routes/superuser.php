...
$app->post(
    ...
    function () use ($app) {
        ...
        if($token){
            ...
            $app->redirect($app->urlFor("super_tokens"), 400);
        }
    }
)->name("super_tokens_generate");
...
)->via('POST', 'PUT')->name('super_member_create-post');
